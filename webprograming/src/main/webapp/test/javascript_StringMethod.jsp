...
<body>
	<script>
		...
		if(position2 == -1){
			...
			document.write("해당하는 단어는 " + position2 + "자리에 있습니다" + "<br>");
		}
		...
		if(position3 == -1){
			...
			document.write("해당하는 단어는 " + position3 + "자리에 있습니다" + "<br>");
		}
		
		//substr 함수 글자 자르기 
		let str4 = "무궁화꽃이 피었습니다.";
		let value = str4.substr(6,3); //substr(6,3) : 6번자리 부터 3개 (0번부터 시작함) -> 피었습
		document.write("값은? : " + value + "<br>");
		let value2 = str4.substring(2,4) //substring(2,3) : 2번자리 다음부터 3번자리까지 -> 화꽃
		document.write("값2은? : " + value2 + "<br>");
